...
public class ShipServiceImpl implements ShipService {
    ...
    @Override
    public List<Ship> getShips(ShipVO shipVO) {
        return makeRequestInDB(shipVO);
    }
    ...
    @Override
    public Long shipCount(ShipVO shipVO) {
        return (long) makeRequestInDB(shipVO).size();
    }
    ...
    private List<Ship> makeRequestInDB(ShipVO shipVO) {
        Optional<String> dtoName = shipVO.getName();
        Optional<String> dtoPlanet = shipVO.getPlanet();
        Optional<String> dtoShipType = shipVO.getShipType();
        Optional<Long> dtoProdDateBefore = shipVO.getBefore();
        Optional<Long> dtoProdDateAfter = shipVO.getAfter();
        Optional<Boolean> dtoIsUsed = shipVO.getIsUsed();
        Optional<Double> dtoSpeedMin = shipVO.getMinSpeed();
        Optional<Double> dtoSpeedMax = shipVO.getMaxSpeed();
        Optional<Integer> dtoCrewSizeMin = shipVO.getMinCrewSize();
        Optional<Integer> dtoCrewSizeMax = shipVO.getMaxCrewSize();
        Optional<Double> dtoRatingMin = shipVO.getMinRating();
        Optional<Double> dtoRatingMax = shipVO.getMaxRating();
        Optional<String> dtoOrder = shipVO.getOrder();
        Optional<Integer> dtoPageNumber = shipVO.getPageNumber();
        Optional<Integer> dtoPageSize = shipVO.getPageSize();
